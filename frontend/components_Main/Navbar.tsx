export default function Navbar() {
  return (
    // Navbar Container
    <div className="flex h-20 items-center justify-between border-b border-gray-300 px-10">
      ...
      <div className="flex items-center gap-8 font-semibold">
        <a
          href="#eboard"
          className="hover:text-gray-600 transition-colors duration-300 ease-in-out hover:scale-110"
        >
          Team
        </a>
        <a
