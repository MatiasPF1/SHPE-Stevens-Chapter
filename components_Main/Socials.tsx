...
export default function SocialsSection() {
  return (
    <section className="pt-10 pb-10 md:pt-2 md:pb-6 md:-mt-2 flex flex-col items-center text-center bg-(--page-bg) md:-translate-y-15">
      ...
      <div className="flex justify-center gap-8 md:gap-16">
        ...
        >
          <div className="w-16 h-16 rounded-2xl border-2 border-(--color-navy) flex items-center justify-center transition-all duration-200 group-hover:border-pink-500 group-hover:text-pink-500">
        ...
        <a
          ...
          className="group flex flex-col items-center gap-2"
        >
          <div className="w-16 h-16 rounded-2xl border-2 border-(--color-navy) flex items-center justify-center transition-all duration-200 group-hover:border-[#0A66C2] group-hover:text-[#0A66C2]">
