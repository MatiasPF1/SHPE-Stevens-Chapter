...
const eBoards: EBoard[] = [
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Angel Zarate",             role: "Academic Chair",                 image: "/team/AngelZarate_AcademicChair.jpg",              description: "Organizes tutoring, study resources, and academic events to support member success." },
      { name: "Antony Saldana",           role: "External Relations",             image: "/team/AnthonySaldana_ExternalRelations.jpg",              description: "Cultivates relationships with alumni, industry partners, and the broader STEM community." },
